...
$${\begin{array}{rl}&{=({\mathrm{a r e a~o f~t h e~r e g i o n~O C P O}})+({\mathrm{a r e a~o f~t h e~r e g i o n~P C Q P}})}\\ &{=\int_{0}^{4}y d x+\int_{4}^{8}y d x}\\ &{=2{\int_{0}^{4}}{\sqrt{x}}d x+{\int_{4}^{8}}{\sqrt{4^{2}-(x-4)^{2}}}d x\quad{\mathrm{(W h y?)}}}\end{array}}$$
...
$$\begin{aligned}(x-2)^{2}+y^{2}&=x^{2}+y^{2}\\x^{2}-4x+4+y^{2}&=x^{2}+y^{2}\\x&=1\\ \text{which gives } y&=\pm\sqrt[3]{3}\end{aligned}$$
