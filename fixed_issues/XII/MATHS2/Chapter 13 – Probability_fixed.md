...
$\mathrm{S}=\{\mathrm{H H H}}$ , HHT, HTH, THH, HTT, THT, TTH, TTT}
...
$\left(\mathrm{H},\mathrm{H}\right),\left(\mathrm{H},\mathrm{T}\right),\left(\mathrm{T},1\right),\left(\mathrm{T},2\right),\left(\mathrm{T},3\right)\left(\mathrm{T},4\right),\left(\mathrm{T},5\right),\left(\mathrm{T},6\right)$ $\operatorname{are}\frac{1}{4},\frac{1}{4},\frac{1}{12},\frac{1}{12},\frac{1}{12},\frac{1}{12},\frac{1}{12},\frac{1}{12}$ respectively which is clear from the Fig 13.2.
...
1.$\mathrm{P}(\mathrm{E}\cap\mathrm{F})=0.2$ , find P(E|F) and P(F|E)and F are events such that h a $$
...
A fair coin and an unbiased die are tossed. Let A be the event head appears on the coin'and B be the event $^{\circ}3$ on the $\mathrm{d i e}^{\prime}$ .Check whether Aand Bare independent events or not.
...
$\begin{aligned}\mathrm{P}(\mathrm{A}$|$\mathrm{E}_{1}$&=\mathrm{P}(\mathrm{a}\mathrm{~g}\mathrm{d}\mathrm{~c}\mathrm{i}\mathrm{i}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{~j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{j}\mathrm{\mathrm{j}\mathrm{j}\mathrm{$\mathrm{j}\mathrm{j}\mathrm{ 'lishe}$ $
...
Of people having HIV, 90% of the test detect the disease but 10% go undetected. Of people free of HIV, 99% of the test are judged HIV-ive but 1% are diagnosed as showing $\mathrm{H I V}+\mathrm{i v e}$ . From a large population of which only 0.1% have HIV, one person is selected at random, given the HIV test, and the pathologist reports him/her as $\mathrm{HIV+ive}$ . What is the probability that the person actually has HIV?
...
Example 20 A doctor is to visit a patient.From the past experience,it is known that 司添are respectively b $\left[\frac{3}{10},\frac{1}{5},\frac{1}{10}\bmod\frac{2}{5}\right]$ (ci).The probabilitiesthat he will be late are $$

 if he comes by train, bus and scooter respectively, but if he comes by other means of transport,thenhe will not belate.When he arrives,heis late.Whatis theprobability that he comes by train?
...
$X=4$ ,when family $f_{2},f_{6}\mathrm{o r}f_{9}$ is selected,
...
Thus,eeealue Also,ls $2\;is\;\frac{1}{10}$ ,$$

 .We write is selected is i ste 
...
Note $\operatorname{I f}x_{_i}$ is one ofthe possiblevaluesof a random variable X, the statement $X=x_{i}$ iula X takes value $x_{i}$ is always nonzero, i.e.$\mathrm{P}(\mathrm{X}=x_{i})\neq0$
...
\sigma_{x}^{2}=\operatorname{Var}(X)=\sum_{i=1}^{n}(x_{i}-\mu)^{2}p(x_{i})
...
{\bf\Pi}_{x}^{2}=\operatorname{E}(\operatorname{X}-\upmu)^{2}
...
\sigma_{x}=\sqrt{\operatorname{Var}(X)}=\sqrt{\sum_{i=1}^{n}(x_{i}-\mu)^{2}p(x_{i})}
...
{\begin{aligned}{\operatorname{V a r}\left(\mathrm{X}\right)}&{{}=\sum_{i=1}^{n}(x_{i}-\upmu)^{2}\;p(x_{i})}\\ &{{}=\sum_{i=1}^{n}(x_{i}^{2}\quad\upmu^{2}\quad2\upmu x_{i})\;p(x_{i})}\\ &{{}=\sum_{i=1}^{n}x_{i}^{2}\;p(x_{i})+\sum_{i=1}^{n}\upmu^{2}\;p(x_{i})-\sum_{i=1}^{n}2\upmu x_{i}p(x_{i})}\\ &{{}=\sum_{i=1}^{n}x_{i}^{2}\;p(x_{i})+\upmu^{2}\;\sum_{i=1}^{n}p(x_{i})-2\upmu\sum_{i=1}^{n}x_{i}p(x_{i})}\\ &{{}=\sum_{i=1}^{n}x_{i}^{2}\;p(x_{i})+\upmu^{2}-2\upmu^{2}\left[\operatorname{s i n c e}\sum_{i=1}^{n}p\;(x_{i}){=}1\mathrm{a n d}\upmu{=}\sum_{i=1}^{n}x_{i}p(x_{i})\right]}\\ &{{}=\sum_{i=1}^{n}x_{i}^{2}\;p(x_{i}){-}\upmu^{2}}\\ &{{}\operatorname{V a r}\left(\mathrm{X}\right)=\sum_{i=1}^{n}x_{i}^{2}\;p(x_{i}){-}\left(\sum_{i=1}^{n}x_{i}\;p(x_{i})\right)^{2}}\\ &{{}\operatorname{V a r}\left(\mathrm{X}\right)=\mathrm{E}(\mathrm{X}^{2})-[\mathrm{E}(\mathrm{X})]^{2},\operatorname{w h e r e}\;\mathrm{E}(\mathrm{X}^{2}){=}\sum_{i=1}^{n}x_{i}^{2}\;p(x_{i})}\end{aligned}}
...
\begin{aligned}\operatorname{Var}(\mathrm{X})&=\mathrm{E}(\mathrm{X}^2)-[\mathrm{E}(\mathrm{X})]^2\\&=\frac{36}{221}-\left(\frac{34}{221}\right)^2=\frac{6800}{(221)^2}\end{aligned}

$$

$$

\sigma_{x}=\sqrt{\operatorname{Var}(X)}=\frac{\sqrt{6800}}{221}=0.37
...
Solution Let the shooter fire n times. Obviously, n fires are n Bernoulli trials. In ach trial,$p=\mathrm{probability}$ y of hitting the ta $\mathrm{arget}=\frac{\dot{3}}{4}$ and $q=\mathrm{p r o b a b i l i t y}$ of not hitting the
...
Let $\mu=\operatorname{E}(X)$ he X.Y of X, denoted by Var (X) or
...
\sqrt{\operatorname{Var}(\mathbf{X})}=\sqrt{\sqrt{n}\left(x_{i}\quad\mu\right)^{2}p(x_{i})}$$
