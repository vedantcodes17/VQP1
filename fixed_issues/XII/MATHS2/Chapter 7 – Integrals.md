...
$$3=0-6\times0+C\quad\mathrm{or}\quad C=3$$
...
$${\mathrm{Hence}},\int{\frac{\sin x}{\sin(x+a)}}d x=x\cos a-\sin a\log\left|\sin(x+a)\right|+C,$$
...
$$(\mathrm{vii})\int\cos\mathrm{ec}x\cot x d x=-\cos\mathrm{ec}x+C\quad(\mathrm{viiii})\int\frac{dx}{\sqrt{1-x^{2}}}=\sin^{-1}x+C $$
