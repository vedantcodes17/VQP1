...
$$\left[{\frac{d}{dx}}(\sin x)=\cos x\right]\frac{d}{dx}(\frac{x^{3}}{3})=x^{2}$$
...
$${\frac{df}{dx}}=f^{\prime}=g^{\prime}-h^{\prime}{\mathrm{giving}}\quad f^{\prime}(x)=g^{\prime}(x)-h^{\prime}(x)\quad\forall\quad x\in\mathrm{~I~}$$

or 

$$f^{\prime}(x)=0,\forall x\in\mathrm{I}\;\mathrm{by}\;\mathrm{hypothesis},$$

i.e., the rate of change of f with respect to x is zero on I and hence f is constant.

In view of the above remark, it is justified to infer that the family $\{\mathrm{F}+\mathrm{C},\mathrm{C}\in\mathrm{\mathbb{R}}\}$ |provides all possible anti derivatives off.
...
Symbolically, we write $\int f(x)d x=\mathrm{F}(x)+\mathbf{C}$ 
...
<div style="text-align: center;"><html><body><table border="1"><tr><td>Symbols/Terms/Phrases</td><td>Meaning</td></tr><tr><td>$\int f(x)d x$</td><td>Integral off with respect to x</td></tr><tr><td>in $\int f(x)d x$ $f(x)$</td><td>Integrand</td></tr><tr><td>x in $\int f(x)d x$</td><td>Variable of integration</td></tr><tr><td>Integrate</td><td>Find the integral</td></tr><tr><td>An integral of f</td><td>A function F such that $\mathrm{F}^{\prime}(x)=f\left(x\right)$</td></tr><tr><td>Integration</td><td>The process of finding the integral</td></tr><tr><td>Constant of Integration</td><td>Any real number C, considered as constant function</td></tr></table></body></html></div>
...
the tangents to all the curves $y=\mathrm{F}_{\mathbb{C}}{(x)},\mathbb{C}\in\mathbb{R}$ , at the points of intersection of the curves by the line $x=a,(a\in\mathbb{R})$ ),are parallel.
...
$${\begin{array}{rl}&{\quad{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\mathrm{\boldmath~\int~}}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int~}}\int_{\mathrm{~\boldmath~\int}}\int_{\mathrm{~\boldmath~\int}}\int_{\mathrm{~\boldmath~\int}}_{\mathrm{\boldmath~\int~}}\int_{\mathrm{\boldmath~\int}}_{\mathrm{\mathrm{\mathrm~{~\boldmath\int~~\int}}}}_{\mathrm{\mathrm{~~\int~\int}}_{\mathrm{\int~\int}}_{\mathrm{\mathrm{~~\int~\int}}}_{\mathrm{\mathrm{~~\int~\int}}}_{\mathrm{\mathrm{~~\int~\int}}}_{\mathrm{\mathrm{\int~~\int~}}_{\mathrm{\mathrm{\mathrm~~\int}{\int}}}_{\mathrm{\mathrm~~\int}{\mathrm{\int~~\int}}}_{\mathrm{\mathrm{~\int~~\int}}}_{\mathrm{\mathrm{\int~~\int}}}_{\mathrm{\mathrm{\int~\int}}_{\mathrm{\mathrm{~\int~}\mathrm{}}}_{\mathrm{\mathrm{\int\mathrm}{\int}}_{\mathrm{\int\mathrm}{\mathrm}{}}_{\mathrm{\int\int}}_{\mathrm{\mathrm{\mathrm}{\int}}}_{\mathrm{\mathrm{\mathrm\int}{}}_{\mathrm{\mathrm{\int\int}\mathrm}{\mathrm}{}}_{\mathrm{\mathrm}{\mathrm}{}_{\mathrm{\int\mathrm}}{}_{\mathrm{}{\int}}_{\mathrm{}{\mathrm}}{d}_{\mathrm{d\mathrm}}{d}_{\mathrm{d\mathrm}}_{}_{\mathrm{d}}_{\mathrm{\mathrm}{d}}_{}_{\mathrm{}{d}_{\mathrm}}{_{\mathrm}{\mathrm}}_{\mathrm{\mathrm}{}}_{}_{\mathrm{\mathrm}{\mathrm}{}\mathrm}_{\mathrm}{}_{\mathrm}{\mathrm}\mathrm{\mathrm}{\mathrm}_{\mathrm}\mathrm{\mathrm}{}_\mathrm{\end{array}}}}}}}}}}$$
...
$$\int\frac{d}{dx}\int f(x)d x=\int\frac{d}{dx}\int g(x)d x.$$

or 

$$\left[{\frac{d}{dx}}\Big[\int f(x)d x-\int g(x)d x\Big]=0\right]$$
...
$$\left\{\left\{\int g(x)d x+\mathbb{C}_{2},\mathbb{C}_{2}\in\mathbb{R}\right\}\mathrm{areidentical}.\right.}$$

Hence, in this sense,$\int f(x)d x\mathrm{and}\int g(x)d x$ :are equivalent.
...
$${\frac{d}{dx}}{\left[\int\left[f(x)+g\left(x\right)\right]d x\right]}=f(x)+g\left(x\right)$$
...
Proof By the Property (I),${\frac{d}{dx}}\int k~f(x)d x=k~f(x)\;.$ 

Also 

$$\left[{\frac{d}{dx}}{\Big[}k\int f(x)d x{\Big]}=k{\frac{d}{dx}}\int f(x)d x=k f(x)\right]$$
...
$$\left\{{\frac{d}{dx}}\sin2x=2\cos2x\right\}$$
...
$$\left[{\frac{d}{dx}}\left(x^{3}+x^{4}\right)=3x^{2}+4x^{3}\right]$$
...
$$\mathrm{F}(0)=3,\mathrm{which gives},3=0-6\times0+C\quad\mathrm{or}\quad C=3$$
...
Put $x=g(t)$ so that ${\frac{dx}{dt}}=g^{\prime}(t)$ 
...
$$\tan^{-1}x=t{\mathrm{~s o~t h a t~}}{\frac{dx}{1+x^{2}}}=d t.$$
...
$$\int\tan x dx=\int\frac{\sin x}{\cos x}dx \begin{aligned}&\begin{aligned}\\ &\text{Put}\cos x=t\text{so that}\sin x dx=-dt\\&\text{until}\\&\text{On}\\&\text{for}\\&\text{for}\\&\text{for}\\&\text{for}\\&\text{for}\\&\text{for}\\&\text{in x}\\&\text{for}\\&\text{in x}\\&\text{for}\\&\text{in x}\\&\text{for}\\&\text{in x}\\&\text{for}\\&\text{in x}\\&\text{for}\\&\text{in x}\\&\text{in}\\&\text{for}\\&\text{in x}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\text{in}\\&\\&\text\\&{in}\\&\text\\&\\&\\&\text{in}\\&\\&\text{in}\\&\\&\\&\text\\&\\&\\&\\&\text\\&{in\\&\\&}\\&\text\\&\\&\\&\\&\\&\\&\text\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\&\\\end{aligned}\end{aligned}$$

Example 6Findthe ollowing iterals:

$$(\mathrm{i})\quad\int\sin^{3}x\cos^{2}x d x\quad(\mathrm{ii})\quad\int{\frac{\sin x}{\sin{(x+a)}}}d x\quad(\mathrm{iii})\quad\int{\frac{1}{1+\tan x}}d x $$
...
$$\begin{aligned}\int\frac{\sin x}{\sin\left(x+a\right)}dx=&\int\frac{\sin\left(t-a\right)}{\sin t}dt\\=&\int\frac{\sin t\cos a-\cos t\sin a}{\sin t}dt\\=&\cos a\int dt-\sin a\int\cot t dt\\=&\left.\left(\cos a\right)t-\left(\sin a\right)\right[\log\left|\sin t\right|+\mathrm{C}_{1}\left]\right.\\=&\left.\left(\cos a\right)\left(x+a\right)-\left(\sin a\right)\right[\log\left|\sin\left(x+a\right)\right|+\mathrm{C}_{1}\left]\right.\\=&\left.x\cos a+a\cos a-\left(\sin a\right)\log\left|\sin\left(x+a\right)\right|-\mathrm{C}_{1}\sin a\right\end{aligned}{\mathrm{Hence}},\int{\frac{\sin x}{\sin(x+a)}}d x=x\cos a-\sin a\log\left|\sin(x+a)\right|+C,$$

where,$\mathrm{C}=-\mathrm{C}_{1}\sin a+a\cos a,$ is another arbitrary constant.

(i)

$$\begin{aligned}\int\frac{dx}{1+\tan x}&=\int\frac{\cos x dx}{\cos x+\sin x}\\&=\frac{1}{2}\int\frac{(\cos x+\sin x+\cos x-\sin x)dx}{\cos x+\sin x}\end{aligned}\begin{aligned}&=\frac{1}{2}\int dx+\frac{1}{2}\int\frac{\cos x-\sin x}{\cos x+\sin x}dx\\ &=\frac{x}{2}+\frac{C_1}{2}+\frac{1}{2}\int\frac{\cos x-\sin x}{\cos x+\sin x}dx\\ \end{aligned}$$

Now, consider $\int\frac{\cos x-\sin x}{\cos x+\sin x}dx$ 

Put cos $x+\sin$ 1$x=t\;{\mathrm{so}}$ that (cos  − sin x)$dx=dt$ 
...
39.$\int{\frac{dx}{\sin^{2}x\cos^{2}x}}\mathrm{equals}$ 
...
$$\begin{aligned}\cos^{2}x&=\frac{1+\cos2x}{2}\\int\cos^{2}x dx&=\frac{1}{2}\int(1+\cos2x)dx=\frac{1}{2}\int dx+\frac{1}{2}\int\cos2x dx\\&=\frac{x}{2}+\frac{1}{4}\sin2x+C\end{aligned}\begin{aligned}(ii)\quad Recall the identity\sin x\cos y=\frac{1}{2}\left[\sin(x+y)+\sin(x-y)\right]\quad&(Why?)\\ Then\quad\int\sin2x\cos3x dx\quad=\quad&\frac{1}{2}\left[\int\sin5x dx\bullet\int\sin x dx\right]\\=\quad&\frac{1}{2}\left[-\frac{1}{5}\cos5x+\cos x\right]+C\\=\quad&-\frac{1}{10}\cos5x+\frac{1}{2}\cos x+C\end{aligned}$$
...
Put cos $x=t\;{\mathrm{so}}$ that − sin x $d x=d t$ 
...
$$\frac{\cos2x-\cos2\alpha}{\cos x-\cos\alpha}\frac{\cos x-\sin x}{1+\sin2x}\tan^{3}2x\sec2x $$
...
(A)(C)${\begin{array}{rl}&{\tan x+\cot x+\mathbf{C}}\\ &{-\tan x+\cot x+\mathbf{C}}\end{array}}$ (B)${\begin{array}{rl}&{\tan x+\csc x+\mathbf{C}}\\ &{\tan x+\sec x+\mathbf{C}}\end{array}}$ 

24.$\int_{\frac{e^{x}(1+x)}{\cos^{2}(e^{x}x)}}d x\mathrm{equals}$ 
...
$$(2) In view of (1) above, we have \frac{1}{a^{2}-x^{2}}=\frac{1}{2a}\left[\frac{(a+x)+(a-x)}{(a+x)(a-x)}\right]=\frac{1}{2a}\left[\frac{1}{a-x}+\frac{1}{a+x}\right]$$ Therefore,
...
$$\int\frac{dx}{\sqrt{x^{2}+a^{2}}}=\int\frac{a\sec^{2}\theta d\theta}{\sqrt{a^{2}\tan^{2}\theta+a^{2}}}=\int\sec\theta d\theta=\log|(\sec\theta+\tan\theta)|+C_{1}\begin{aligned}&\frac{\sqrt[3]{x}}{x}=\frac{\sqrt[3]{x}}{\log\left|\frac{x}{a}+\sqrt{\frac{x^2}{a^2}+1}\right|}+C_1\\ &=\frac{\sqrt[3]{x}}{\log\left|x+\sqrt{x^2+a^2}\right|}-\log|a|+C_1\\ &=\frac{\sqrt[3]{x}}{\log\left|x+\sqrt{x^2+a^2}\right|}+C_1,where C=C_1-\log|a|.\\ \end{aligned}$$
...
(7) To find the integral $\int{\frac{dx}{a x^{2}+b x+c}}$ , we write 
...
$${\begin{aligned}{{\stackrel{\cdot}{\int}}{\frac{dx}{{\sqrt{5x^{2}-2x}}}}=}&{{}{\frac{dx}{{\sqrt{5{\left(x^{2}-{\frac{2x}{5}}\right)}}}}}}\\ {=}&{{}{\frac{\cdot}{{\sqrt{5}}}}{\frac{dx}{{\sqrt{\left(x-{\frac{1}{5}}\right)^{2}-{\left({\frac{1}{5}}\right)^{2}}}}}}{\pmod{{\mathrm{s u p l e t i n g~t h e~s q u a r e}}}}}\end{aligned}}$$
...
$${\begin{aligned}{4\mathrm{A}=1{\mathrm{~a n d~}}6\mathrm{A}+\mathrm{B}=2\quad{\mathrm{or}}\quad\mathrm{A}}&{{}={\frac{\stackrel{\cdot}{1}}{4}}{\mathrm{~a n d~}}\mathrm{B}={\frac{1}{2}}.}\\ {{\mathrm{Therefore}},\qquad{\stackrel{\cdot}{\int}}{\frac{x+2}{2x^{2}+6x+5}}}&{{}={\frac{\stackrel{\cdot}{1}}{4}}{\int}{\frac{4x+6}{2x^{2}+6x+5}}d x+{\frac{1}{2}}{\int}{\frac{dx}{2x^{2}+6x+5}}}\\ &{{}={\frac{\stackrel{\cdot}{1}}{4}}\mathrm{I}_{1}+{\frac{1}{2}}\mathrm{I}_{2}\quad{\mathrm{(s a y)}}}\end{aligned}}$$
...
$$\mathrm{I}_{2}=\int\frac{dx}{2x^{2}+6x+5}=\frac{1}{2}\int\frac{dx}{x^{2}+3x+\frac{5}{2}}\frac{1}{2}\int_{\left(x+\frac{3}{2}\right)^2+\left(\frac{1}{2}\right)^2}^{\left(x+\frac{3}{2}\right)^2}\mathrm{d}x $$
...
$$x+3=\mathrm{A}\frac{d}{dx}\left(5-4x-x^{2}\right)+\mathrm{B}=\mathrm{A}\left(-4-2x\right)+\mathrm{B}$$
...
In $ I_{i}$ , put $5-4x-x^{2}=t.$ so that $(-4-2x)\;d x=d t.$ 
...
$$\frac{1}{\sqrt{9-25x^{2}}}\frac{x-1}{\sqrt{x^{2}-1}}$$

5.

8.

$$\frac{3x}{1+2x^{4}}\frac{x^{2}}{\sqrt{x^{6}+a^{6}}}$$

6.

9.

$$\frac{x^{2}}{1-x^{6}}\frac{\sec^{2}x}{\sqrt{\tan^{2}x+4}}$$
...
$$\frac{1}{\sqrt{(x-1)(x-2)}}\frac{1}{\sqrt{8+3x-x^{2}}}$$
...
how to integrate polynomials, the integration of any rational function is reduced o the integration of a proper rational function.The rational functions which we shall consider here for integration purposes will be those whose denominators can be factorised into linear and quadratic factors. Assume that we want to evaluate $\int_{\frac{\mathrm{P}(x)}{\mathrm{Q}(x)}d x}^{\mathrm{P}(x)}\mathrm{d}x,\mathrm{where}\frac{\mathrm{P}(x)}{\mathrm{Q}(x)}$ 
...
Example 11 Find $\int{\frac{dx}{\left(x+1\right)\left(x+2\right)}}$ 
...
SolutionConsider $\frac{x^{2}}{(x^{2}+1)(x^{2}+4)}\mathrm{and}\mathrm{put}x^{2}=y.$ 
...
$$\mathrm{A}=-{\frac{1}{3}}\quad{\mathrm{and}}\quad\mathrm{B}={\frac{4}{3}}$$
...
$$\begin{aligned}\mathrm{I}&=\int[\frac{3}{y-2}+\frac{4}{\left(y-2\right)^{2}}]d y=3\int\frac{dy}{y-2}+4\int\frac{dy}{\left(y-2\right)^{2}}\\&=3\log\left|y-2\right|+4\left(-\frac{1}{y-2}\right)+\mathbf{C}\\&=3\log\left|\sin\phi-2\right|+\frac{4}{2-\sin\phi}+\mathbf{C}\\&=3\log\left(2-\sin\phi\right)+\frac{4}{2-\sin\phi}+\mathbf{C}(\mathrm{since},2-\sin\phi\mathrm{i s~a l w a y s~p o s i t i v e})\\ \end{aligned}$$
...
16.$\frac{1}{x\left(x^{n}+1\right)}$ [Hint: multiply numerator and denominator by $x^{n-1}\mathrm{and}\mathrm{put}x^{n}=t$ 
...
21.$\frac{1}{(e^{x}-1)}\left[\mathrm{Hint}:\mathrm{Put}\;e^{x}=t\right]$ 
...
23.$\int{\frac{dx}{x(x^{2}+1)}}{\mathrm{~e q u a l s}}$ 
...
$\frac{d}{dx}(u v)=u\frac{dv}{dx}+v\frac{du}{dx}$ Integrating both sides, we get 
...
$${\begin{aligned}{uv}&{{}=\int u{\frac{dv}{dx}}d x+\int v{\frac{du}{dx}}d x}\\ {\int u{\frac{dv}{dx}}d x}&{{}=u v-\int v{\frac{du}{dx}}d x}\\ {u}&{{}=f(x){\mathrm{~a n d~}}{\frac{dv}{dx}}{=}{\mathrm{~g}}(x).{\mathrm{~T h e n~}}}\\ {{\frac{du}{dx}}}&{{}=f^{\prime}(x){\mathrm{~a n d~}}v=\int g(x)d x}\end{aligned}}$$
...
$$f(x)=\cos x{\mathrm{~a n d~}}g\left(x\right)=x.{\mathrm{~T h e n~}}\begin{aligned}\int\int x\cos x dx&=\cos x\int x dx-\int[\frac{d}{dx}(\cos x)\int x dx]dx\\&=(\cos x)\frac{x^2}{2}+\int\sin x\frac{x^2}{2}dx\end{aligned}$$
...
Example 22 Find (i)$\int e^{x}(\tan^{-1}x+{\frac{1}{1+x^{2}}})d x\quad({\mathrm{ii}})\int{\frac{(x^{2}+1)e^{x}}{(x+1)^{2}}}d x$ 
...
1.x sin x 2.$x\;\mathrm{sin}\;3x$ 3.$x^{2}\ e^{x}$ 4.$x\log x$ 
...
(A)$e^{x}\cos x+\mathbf{C}$ (B)$e^{x}\;{\mathrm{sec}}\;x+\mathbf{C}$ (C)$e^{x}\sin x+\mathbf{C}$ (D)$e^{x}\tan x+\mathbf{C}$ 
...
$$(\mathrm{i})\quad\int\sqrt[]{x^{2}-a^{2}}~d x\quad(\mathrm{ii})\quad\int\sqrt[]{x^{2}+a^{2}}~d x\quad(\mathrm{iii})\quad\int\sqrt[]{a^{2}-x^{2}}~d x $$
...
lower limit of the integral and  is called the upper limit of the integral. The definite integral is introduced either as the limit of a sum or if it has an anti derivative F in the interval [a, ], then its value is the difference between the values of F at the end points, i.e.,$\mathrm{F}(b)-\mathrm{F}(a)$ b. Here, we shall consider these two cases separately as discussed below:
...
$[x_{r-1},x_{r}],...,[x_{n-1},x_{n}]$ ,where $\begin{array}{r}{\stackrel{\leftrightarrow}{x_{0}}=a,x_{1}=a+h,x_{2}=a+2h,\ldots,x_{r}=a}\end{array}$ 

$x_{n}=b=a+n h{\mathrm{~o r~}}n={\frac{b-a}{h}}$ • We note that as $n\to\infty,h\to0$ 



The region PRSQP under consideration is the sum of n subregions, where each sub [T]$[x_{r-1},x_{r}],r=1,2,3,...,n$ 

From Fig 7.2, we have 

area of the rectangle $\left(\mathrm{ABLC}\right)\mathrm{<a r e a}$ of the region $\left(\mathrm{ABDCA}\right)<$ area of the rectangle (ABDM)[D]a .. (1)
...
Here,$S_{n}$ and $\mathrm{S}_{n}$ doe raised over subintervals $[x_{r-1},x_{r}]\;\mathrm{for}\;r{=}1,2,3,{\ldots},n$ , respectively.

In view of the inequality (1) for an arbitrary subinterval $[x_{r-1},x_{r}]$ , we have 

$$s_{n}<\mathrm{a r e a~o f~t h e~r e g i o n~P R S Q P}<\mathrm{S}_{n} .$$
...
c t or u instead of x, we simply write the integral as $\int_{a}^{b}f(t)d t\mathrm{or}\int_{a}^{b}f(u)$ du instead of $\int_{a}^{b}f(x)d x$ . Hence, the variable of integration is called a dummy variable.
...
in Fig 7.3 [Here it is assumed that $f(x)>0\;{\mathrm{for}}\;x\in[a,b]$ , the assertion made below is equally true for other functions as well]. The area of this shaded region depends upon the value of x.
...
$$\mathrm{Let}\;\mathrm{I}=\int_{2}^{3}x^{2}\;d x\;.\;\mathrm{Since}\;\int x^{2}\;d x=\frac{x^{3}}{3}=\mathrm{F}\left(x\right),$$
...
$$\mathrm{Put}^{\prime}30-x^{\frac{3}{2}}=t.\mathrm{Then}-\frac{3}{2}\sqrt{x}d x=d t\mathrm{or}\sqrt{x}d x=-\frac{2}{3}d t.$$
...
$$\begin{aligned}\mathrm{I}=&\mathrm{F}(2)-\mathrm{F}(1)=[-\log3+2\log4]-[-\log2+2\log3]\\=&-3\log3+\log2+2\log4=\log\left(\frac{32}{27}\right)\end{aligned}\mathrm{Let}\mathrm{I}=\int_{0}^{\frac{\pi}{4}}\sin^32t\cos2t dt.\mathrm{Consider}\int_{0}^{\frac{\pi}{4}}2t\cos2t dt.$$
...
22.$\int_{0}^{\frac{2}{3}}{\frac{dx}{4+9x^{2}}}\quad\mathrm{equals}$ 
...
1. Consider the integral without limits and substitute,$y=f(x)\mathrm{or}x=g(y)$ to reduce the given integral to a known form.
...
$$\int_{-1}^{1}5x^4\sqrt{x^5+1}dx=\frac{2}{3}\left[(x^5+1)^{\frac{3}{2}}\right]_{-1}^{1}={\frac{2}{3}}\left[\left(1^{5}+1\right)^{\frac{3}{2}}-\left(\left(-1\right)^{5}+1\right)^{\frac{3}{2}}\right]\frac{2}{3}\left[2^{\frac{3}{2}}-0^{\frac{3}{2}}\right]=\frac{2}{3}(2\sqrt{2})=\frac{4\sqrt{2}}{3}$$

with new limits.



Let Note that, when $\begin{array}{rl}&{t=x^{5}+1.\mathrm{~T h e n~}d t=5x^{4}d x.}\\ &{x=-1,t=0\mathrm{~a n d~w h e n~}x=1,t=2.}\end{array}$ Thus, as x varies from –1 to 1, t varies from 0 to 2
...
10.$\mathrm{If}f(x)=\int{}_{0}^{x}t$ sint dt , then $f^{\prime}(x)$ is 

(A)$\mathrm{cos}x+x\;\mathrm{sin}\;x$ (B)$x\;{\mathrm{sin}}x$ (C)$x{\tt c o s}x$ (D)$\mathrm{sin}x+x\mathrm{cos}x$  ### 7.10 Some Properties of Definite Integrals 
...
Proof of $\mathbf{P}_{4}\mathrm{Put}t=a-x$ .Then $d t=-d x$ . When $x=0,t=a$ and when $x=a,t=0$ .Now proceed as in $\mathrm{P}_{3}$ .
...
Example 31 Evaluate $$ T 

Solution We observe that $\sin^{2}x$ is an even function.Therefore, b \int_{\frac{-\pi}{4}}^{\frac{\pi}{4}}\sin^{2}x d x=2\int_{0}^{\frac{\pi}{4}}\sin^{2}x d x \begin{aligned}&\stackrel{\pi}{=}2\int_{0}^{\frac{\pi}{4}}\frac{(1-\cos2x)}{2}dx=\int_{0}^{\frac{\pi}{4}}(1-\cos2x)dx\\ &=\left[x-\frac{1}{2}\sin2x\right]_{0}^{\frac{\pi}{4}}=\left(\frac{\pi}{4}-\frac{1}{2}\sin\frac{\pi}{2}\right)-0=\frac{\pi}{4}-\frac{1}{2}\\ \end{aligned}$$
...
$f\left(-x\right)=\sin^{5}\left(-x\right)\cos^{4}\left(-x\right)=-\sin^{5}x\cos^{4}x=-f\left(x\right)$ , f is an odd function.Therefore, by $\mathrm{P}_{7}(\mathrm{ii}),\mathrm{I}=0$ 
...
Example 35 Evaluate $\int_{\frac{\pi}{6}}^{\frac{\pi}{3}}{\frac{dx}{1+{\sqrt{\tan x}}}}$ 
...
$$2\mathrm{I}=\int_{\frac{\pi}{6}}^{\frac{\pi}{3}}d x=\left[x\right]_{\frac{\pi}{6}}^{\frac{\pi}{3}}=\frac{\pi}{3}-\frac{\pi}{6}=\frac{\pi}{6}.\mathrm{Hence}^{\mathrm{\scriptsize~\cdot~}}\mathrm{I}=\frac{\pi}{12}$$
...
$$\int_{0}^{\frac{\pi}{2}}\frac{\sin x-\cos x}{1+\sin x\cos x}dx \int_{0}^{\pi}\log\left(1+\cos x\right)dx \int_{0}^{a}\frac{\sqrt{x}}{\sqrt{x}+\sqrt{a-x}}dx $$
...
$$\mathrm{we}\mathrm{have}\int{\frac{dx}{\log x}}=\left[{\frac{x}{\log x}}-\int x\left\{-{\frac{1}{(\log x)^{2}}}\left({\frac{1}{x}}\right)\right\}d x\right]$$
...
$$\mathrm{I}=\int t\left(1+{\frac{1}{t^{2}}}\right){\frac{2t}{(1+t^{4})}}d t.2\int\frac{\left(t^{2}+1\right)}{t^{4}+1}dt=2\int\frac{\left(1+\frac{1}{t^{2}}\right)dt}{\left(t^{2}+\frac{1}{t^{2}}\right)}=2\int\frac{\left(1+\frac{1}{t^{2}}\right)dt}{\left(t-\frac{1}{t}\right)^{2}+2}$$

Put $t-\frac{1}{t}=y,\mathrm{so}\mathrm{that}\left(1+\frac{1}{t^{2}}\right)d t=d y.$ . Then 
...
$$\begin{aligned}&Therefore\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad\quad \end{aligned}$$
...
$$\frac{-1}{\sin x+\cos x}+C \log\left|\sin x-\cos x\right|+C $$

(B)

(D)

$$\left[\log\left|\sin x+\cos x\right|+C\right]\frac{1}{\left(\sin x+\cos x\right)^{2}}$$

43.$\mathrm{If}f\left(a+b-x\right)=f\left(x\right)$ ,then $\int_{a}^{b}x f(x)$ dx is equal to 
...
$$\int\sec x\tan x dx=\sec x+C (\mathrm{vii})\int\cos\mathrm{ec}x\cot x d x=-\cos\mathrm{ec}x+C\quad(\mathrm{viiii})\int\frac{dx}{\sqrt{1-x^{2}}}=\sin^{-1}x+C $$
...
$$\int_{\frac{dx}{1+x^{2}}}^{\frac{dx}{1+x^{2}}}=-\cot^{-1}x+C $$
...
Recall that a rational function is ratio of two polynomials of the form $\frac{\mathbf{P}(x)}{Q(x)}$ where $\mathbf{P}(x)$ and $\mathrm{~Q~}(x)$ are polynomials in x and $\mathbb{Q}\left(x\right)\neq0$ .If degree of the polynomial $\mathrm{P}\left(x\right)$ is greater than the degree of the polynomial $\mathrm{~Q~}(x)$ , then we may divide $\mathrm{P}\left(x\right)$ by $\mathrm{Q}\left(x\right)$ sothat $\frac{\mathbf{P}(x)}{\mathbf{Q}(x)}=\mathbf{T}(x)+\frac{\mathbf{P}_{1}(x)}{\mathbf{Q}(x)}$ where $\mathrm{T}(x)$ is a polynomial in x and degree of $\mathrm{P}_{1}(x)$ is less than the degree of $\mathbf{Q}(x)$ $\mathrm{T}\left(x\right)$ being polynomial can be easily integrated.$\left\{\frac{\mathbf{P}_{1}(x)}{\mathbf{Q}(x)}\right.}$ can be integrated by  expressing $\frac{\mathbf{P}_{1}(x)}{\mathbf{Q}(x)}$ as the sum of partial fractions of the following type:
...
$$\int\frac{dx}{a^{2}-x^{2}}=\frac{1}{2a}\log\left|\frac{a+x}{a-x}\right|+C\quad(iii)\quad\int\frac{dx}{x^{2}+a^{2}}=\frac{1}{a}\tan^{-1}\frac{x}{a}+C \int\frac{dx}{\sqrt{x^{2}-a^{2}}}=\log\left|x+\sqrt{x^{2}-a^{2}}\right|+C\left(\mathrm{v}\right)\int\frac{dx}{\sqrt{a^{2}-x^{2}}}=\sin^{-1}\frac{x}{a}+C $$
...
■We have defined $\int{}_{a}^{b}f(x)$ dx as the area of the region bounded by the curve $y=f(x),a\leq x\leq b$ , the x-axis and the ordinates $x=a{\mathrm{~a n d~}}x=b$ .Letx be a given point in $[a,b]$ Then $\int{}_{a}^{x}f(x)$ dxrepresents the Area function $\mathrm{A}\left(x\right)_{\cdot}$ This concept of area function leads to the Fundamental Theorems of Integral Calculus.
...
Letf be a continuous function of x defined on the closed interval $[a,b]$ and let F be another function such that ${\frac{d}{dx}}\mathrm{F}(x)=f(x)$ for all x in the domain of 
