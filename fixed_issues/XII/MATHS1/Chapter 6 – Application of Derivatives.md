...
Now,$f^{\prime}(x)>0\text{ for all }x\in\left[0,\frac{\pi}{6}\right]\mathrm{and} 0\leq x<\frac{\pi}{6}\Rightarrow0\leq3x<\frac{\pi}{2}]$ and $f^{\prime}(x)<0$ for all $x\in\left(\frac{\pi}{6},\frac{\pi}{2}\right)\quad as\quad\frac{\pi}{6}<x<\frac{\pi}{2}\Rightarrow\frac{\pi}{2}<3x<\frac{3\pi}{2}$ 
...
$$\text{er er } f^{\prime}(x)>0 \text{if } x \in \left[0,\frac{\pi}{4}\right] \cup \left(\frac{5\pi}{4},2\pi\right]$$
...
or f is increasing in the intervals$\left[0,\frac{\pi}{4}\right] \cup \left(\frac{5\pi}{4},2\pi\right]$ Also 2$f^{\prime}(x)<0if x\in\left(\frac{\pi}{4},\frac{5\pi}{4}\right)$ 
