...
$$not to \begin{aligned}\frac{dV}{dt}&=\frac{dV}{dt}\cdot\frac{dV}{dt}\\9&=\frac{dV}{dt}=\frac{d}{dt}(x^3)=\frac{d}{dx}(x^3)\cdot\frac{dx}{dt}\quad(By Chain Rule)\\&=3x^2\cdot\frac{dx}{dt}\\frac{dx}{dt}&=\frac{3}{x^2}\\frac{dS}{dt}&=\frac{d}{dt}(6x^2)=\frac{d}{dx}(6x^2)\cdot\frac{dx}{dt}\quad(By Chain Rule)\\&=12x\cdot\left(\frac{3}{x^2}\right)=\frac{36}{x}\quad(Using(1))\end{aligned}$$
...
Note $\frac{dy}{dx}$ ispositiveiincrasicaeandisngativeidcreas asx increases.
...
1.Find therateofchangeof the areaof acircle with respectto its radius when (a)$r=3cm$ (b)$r=4\mathrm{cm}$ 
...
_(ii) decreasing on I,$\mathrm{if}x_{1}<x_{2}\mathrm{in}\mathrm{I}\Rightarrow f(x_{1})\geq f(x_{2})$ EM $\mathrm{if}x_{1}<x_{2}\mathrm{in}\mathrm{I}\Rightarrow f(x_{1})\geq f(x_{2})$ for all $x_{1},x_{2}\in\mathrm{I}$ 
...
(v) strictly decreasing on I if $x_{1}<x_{2}\quad in\quad\quad f(x_{1})>f(x_{2})$ for all $x_{1},x_{2}\in\mathrm{I}$ For graphical representation of such functions see Fig 6.2.
...
Definition 2 Let $x_{0}$ beapoint in thedomaiof deiitionofal valued futio Then $f$ is said to be increasing, decreasing at $x_{0}if$ there exists an open interval I containing $x_{0}$ 
...
$$f(x)=x^{3}-3x^{2}+4x,x\in\mathbf{R}\begin{aligned}\vec{f}^{\prime}(x)&=3x^{2}-6x+4\\&=3(x^{2}-2x+1)+1\\&=3(x-1)^{2}+1>0,in every interval of\mathbb{R}\end{aligned}$$
...
In the intervals $(-\infty,-2)\mathrm{and}(3,\infty),f^{\prime}(x)$ is positive while in the interval $(-2,3)$ 1,$f^{\prime}(x)$ isnegative.Coqlthio $f$ is increasing in the intervals $(-\infty,-2)$ and (3,∞) whilethefunction is decreasing in the interval (−2,3).However,f is neither increasing nor decreasing in R.
...
Therefore,$f^{\prime}(x)=0gives\cos3x=0which$ $3x=\frac{\pi}{2},\frac{3\pi}{2}(as x\in\left[0,\frac{\pi}{2}\right])$ implies $3x\in\left[0,\frac{3\pi}{2}\right]\quad\text{So}x=\frac{\pi}{6}\quad\text{and}\quad\frac{\pi}{2}$ The point$x={\frac{\pi}{6}}$ divides the interval $\left[0,\frac{\pi}{2}\right]$ into two disjoint intervals $\left[0,\frac{\pi}{6}\right]\mathrm{and}\left(\frac{\pi}{6},\frac{\pi}{2}\right)$ 0π6元2
...
or f is increasing in the intervals$\left[0,\frac{\pi}{4}\right\;\mathrm{and}\;\left(\frac{5\pi}{4},2\pi\right])$ Also 2$f^{\prime}(x)<0if x\in\left(\frac{\pi}{4},\frac{5\pi}{4}\right)$ 

or $f is decreasing in\left(\frac{\pi}{4},\frac{5\pi}{4}\right)$ 


<div style="text-align: center;"><html><body><table border="1"><tr><td>Interval</td><td>$\mathrm{S i g n\;o f}^{'}f^{\prime}(x)$</td><td>Nature of function</td></tr><tr><td>$\left[0,{\frac{\pi}{4}}\right]$</td><td>$\geq0$</td><td>f is increasing</td></tr><tr><td>$\left(\frac{\pi}{4},\frac{5\pi}{4}\right)$</td><td>$\leq0$</td><td>f is decreasing</td></tr><tr><td>$\left[\frac{5\pi}{4},2\pi\right]$</td><td>$\geq0$</td><td>f is increasing</td></tr></table></body></html></div>
...
(a) increasing in $\left(0,\frac{\pi}{2}\right)$ $\mathrm{decreasing}\left(\frac{\pi}{2},\pi\right)$ 
...
15.$f(x)=x+\frac{1}{x}$ ,is increasing on I.fomm $$ Prove that thefunction given by 
...
$$f^{\prime}(c)=0increasing f^{\prime}(c)=0$$
...
(i)$\mathrm{If}f^{\prime}(x)$ changes sign from positive to negative as  increases through c, i.e., if $f^{\prime}(x)>0$ at every pointsuficientlycloseto and to the left of $c,$ and $f^{\prime}(x)<0$ at every point sufficientlyclose to and to the rightof ,then is a point of local maxima 
...
(iii)$\mathrm{If}f^{\prime}(x)$ does not change sign as x increases through c, then c is neither a point of local maxima or apoint of local minima.Infact,such a point iscalled point of inflection (Fig 6.13).
...
<div style="text-align: center;">$$ ; 6.16</div>


$$[T]0m  ; 6.16\mathrm{S}\equiv\mathrm{S}(x)=\mathrm{RP}^{2}+\mathrm{RQ}^{2}=2x^{2}-40x+1140.\mathrm{S}\equiv\mathrm{S}(x)=\mathrm{RP}^{2}+\mathrm{RQ}^{2}=2x^{2}-40x+1140.$$
...
$$x=5.\;Now \begin{aligned}\mathrm{A}^{\prime\prime}(x)&=\frac{\sqrt{100-x^{2}}(-4x-10)-(-2x^{2}-10x+100)\frac{(-2x)}{2\sqrt{100-x^{2}}}}{100-x^{2}}\\&=\frac{2x^{3}-300x-1000}{(100-x^{2})^{\frac{3}{2}}}\quad(\mathrm{on}\mathrm{sim}\mathrm{i})\end{aligned}$$
...
$$\left\{\begin{aligned}\mathrm{S}'(x)&=\frac{2\pi h}{r}(r-2x)\\ \mathrm{S}''(x)&=\frac{-4\pi h}{r}\end{aligned}\right.}\mathrm{Now}\;\mathrm{S}'(x)=0\;\mathrm{gives}\;x=\frac{r}{2}\;\mathrm{Since}\;\mathrm{S}''(x)<0\;\mathrm{for}\;\mathrm{all}\;x,\;\mathrm{S}''\left(\frac{r}{2}\right)<0.\;\mathrm{So}\;x=\frac{r}{2}\;\mathrm{is}\;\mathrm{a}$$
...
$$f(-1)=12(-1)^{\frac{4}{3}}-6(-1)^{\frac{1}{3}}=18f\left(\frac{1}{8}\right)=12\left(\frac{1}{8}\right)^{\frac{4}{3}}-6\left(\frac{1}{8}\right)^{\frac{1}{3}}=\frac{-9}{4}f(1)=12(1)^{\frac{4}{3}}-6(1)^{\frac{1}{3}}=6$$
...
$$f(x)=x^{3}-6x^{2}+9x+15\quad(vi)\quad g(x)=\frac{x}{2}+\frac{2}{x},\quad x>0 shed shed g(x)=\frac{1}{x^{2}+2}\quad(\mathrm{vii})\quad f(x)=x\sqrt{1-x},\quad0<x<1$$

Prove that the following functions do not have maxima or minima:

$$(i)f(x)=e^{x}\quad(\mathrm{ii})\quad g(x)=\log x$$\begin{array}{r}{\mathrm{(i i i)}\quad h\left(x\right)=x^{3}+x^{2}+x+1}\end{array}$ $$
...
$$\frac{dV}{dt}=\frac{d}{dh}\left(\frac{\pi h^3}{12}\right)\cdot\frac{dh}{dt}=\frac{\pi}{4}h^2\frac{dh}{dt}$$
...
In this case, we have $$ [Ta]

$=6>0$ (In particular, observe that for $$ (-)(−3)
...
x-1>0,x+2>0and x-3\leq0. Now con,n , i.e., when $$ .In this case, we have .n is , e a 
...
$$f(x)=\tan^{-1}(\sin x+\cos x),x>0\cos x-\sin x $$
...
Solution Let $\mathrm{S}\left(x\right)$ be the selling price of x items and let $\mathrm{C}\left(x\right)$ be the cost price of items. Then, we have 
...
Thus, the profit function $\mathrm{P}\left(x\right)$ is given by 
...
$$\mathrm{P}^{\prime}(x)=\frac{24}{5}-\frac{x}{50}\mathrm{Now}P^{\prime}(x)=0\text{gives}x=240.\mathrm{Also}P^{\prime\prime}(x)=\frac{-1}{50}\cdot\mathrm{So}P^{\prime\prime}(240)=\frac{-1}{50}<0 'lished $$
...
(i)$\mathrm{If}f^{\prime}(x)$ changes sign from positive to negative asincreases through c,i.e.,$\mathrm{if}f^{\prime}(x)>0$ at every point sufficienlyclose to and to the left of c,and $f^{\prime}(x)<0$ at every point sufficientlyclosetoand totherightof c,then c is a point of local maxima.



(ii)$\mathrm{If}f^{\prime}(x)$ changes sign from negative to positive as x increases through $c,$ i.e., if $f^{\prime}(x)<0$ at every point sufficiently close to and to the left of $c,$ and $f^{\prime}(x)>0$ at every point sufficiently close to and to the right of $c,$ then c is a point of local minima.



(iii)$\mathrm{If}f^{\prime}(x)$ does not change sign as x increases through c, then c is neither apointof lcalmaximooitoloaliima.In,uchaoint is called point of inflexion.
