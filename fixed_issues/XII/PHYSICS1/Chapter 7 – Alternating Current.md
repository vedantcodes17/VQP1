...
$$v_{m}\sin\omega t=i R i=\frac{v_m}{R}\sin\omega t $$
...
and since $1/2\left(1–\cos2\omega t\right)$ $\mathrm{e}<\cos2\omega t>=0^{\frac{1}{2}}$ , we have ion $\mathrm{{:\leq sin^{2}}}$ $\mathrm{e}<\cos2\omega t>=0^{\frac{1}{2}}$ ω$$ identity,ave,tity,<\sin^{2}\omega t>=\frac{1}{2}$$
...
$$-\cos(\omega t)=\sin\left(\omega t-\frac{\pi}{2}\right)i=i_m\sin\left(\omega t-\frac{\pi}{2}\right)$$
...
$$\mathbf{v}_{\mathbf{R}}\mathbf{\widehat{v_{R}}}\mathbf{V}_{\mathrm{c}}+\mathbf{V}_{\mathrm{L}}$$
...
$$R=200\Omega,C=15.0\mu\mathrm{F}=15.0\times10^{-6}\mathrm{F}V=220V,v=50Hz $$
...
$$P=\frac{v_m i_m}{2}\cos\phi=\frac{v_m}{\sqrt{2}}\frac{i_m}{\sqrt{2}}\cos\phi =V I\cos\phi $$
...
$$(a) To find the impedance of the circuit, we first calculate \begin{cases}X_{L}=2\pi\mathrm{v}L\\quad=2\times3.14\times50\times25.48\times10^{-3}\Omega=8\Omega\\quad X_{C}=\displaystyle\frac{1}{2\pi\gamma C}\end{cases}\frac{1}{1}=\frac{1}{2\times3.14\times50\times796\times10^{-6}}=4\Omega $$
...
$$P=I^{2}R \mathrm{NOW},I=\frac{i_m}{\sqrt{2}}=\frac{1}{\sqrt{2}}\left(\frac{283}{5}\right)=40\mathrm{A}P=(40\mathrm{A})^2\times3\Omega=4800\mathrm{W}$$
...
$$v_{s}=-N_{s}\frac{\;d\phi}{\;d t}v_{p}=-N_{p}\frac{d\phi}{dt}$$
