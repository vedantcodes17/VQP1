...
$$\mathbf{F}=\frac{\mathrm{d}\mathbf{p}}{\mathrm{d}t}=m\mathbf{a}$$
 ...
 In SI unit force is one that causes an acceleration of 1 m $\mathbf{S}^{-2}$ to a mass of 1 kg. This unit is known as newton :$1\;\mathrm{N}=1\;\mathrm{kg}\;\mathrm{m}\;\mathrm{s}^{-2}$
...
$$=0.04\;\mathrm{kg}\quad6750\;\mathrm{m}\;\mathrm{s}^{-2}=270\;\mathrm{N}$$
...
$$\begin{array}{c}{{\mathbf{F}_{_{A B}}\;=\;-\mathbf{F}_{_{B A}}}}\\ {{\mathrm{(f o r c e~o n}\;A\;\mathrm{by}\;B)\;=\;-\mathrm{(f o r c e~o n}\;B\;\mathrm{by}\;A)}}\end{array}$$
...
$$\left(p_{x}\right)_{\mathrm{initial}}=m u\quad\left(p_{y}\right)_{\mathrm{initial}}=0.\quad\left(p_{x}\right)_{\mathrm{final}}=-m u\quad\left(p_{y}\right)_{\mathrm{final}}=0.$$
...
We know from experience that as the applied force exceeds a certain limit, the body begins to move. It is found experimentally that the limiting value of static friction $\left[\left(f_{s}\right.\right)_{\mathrm{max}}]$ is independent of the area of contact and varies with the normal force(N) approximately as:

$$\left(f_{s}\right)_{\mathrm{max}}=\mu_{s}N $$
...
$$m g\mathrm{sin}\quad\theta=f_{_{\mathrm{s}}}\quad,\quad m g\quad\mathrm{cos}\quad\theta\quad=N $$

As θ increases, the self-adjusting frictional force $f_{s}$ increases until at $\theta=\theta_{m a x},\quad f_{s}$ achieves its maximum value,$\left[\left(f_{s}\right)_{\mathrm{max}}=\mu_{_{s}}N_{s}\right.]$
...
$$\mathrm{tor}v_{\mathrm{max}}=\left(R g\frac{\mu_{s}+t a n\theta}{1-\mu_{s}t a n\theta}\right)^{\frac{1}{2}}$$
...
$$\begin{array}{l}{\mu_{\mathrm{s}}=O\mathrm{in}\mathrm{E q.}(4.21),}\\ {v_{\mathrm{o}}=(R g\tan\theta)^{\%}}\end{array}$$
...
$$f_{S}\leq\left(f_{S}\right)_{\mathrm*{m a x}}=\mu_{S}R $$
...
<div style="text-align: center;"><html><body><table border="1"><thead><tr><td>Quantity</td><td>Symbol</td><td>Units</td><td>Dimensions</td><td>Remarks</td></tr></thead><tbody><tr><td>Momentum</td><td>p</td><td>kg m orN s ${\bf S}^{-1}$</td><td>[MLT</td><td>Vector</td></tr><tr><td>Force</td><td>F</td><td>N</td><td>[MLT]</td><td>Second Law $\mathbf{F}=m\mathbf{a}$</td></tr><tr><td>Impulse</td><td></td><td>kg m s−1 or N s</td><td>[M LT]</td><td>= change in momentum $\mathrm{Impulse}=\mathrm{force}\times\mathrm{time}$</td></tr><tr><td>Static friction</td><td>$\mathbf{f}_{\mathrm{s}}$</td><td>N</td><td>[MLT</td><td>$\mathbf{f}_{\mathrm{s}}\;\leq\;\mu_{\mathrm{s}}\;\mathbf{N}$</td></tr><tr><td>Kinetic friction</td><td>$\pmb{\mathscr{f}}_{\mathrm{k}}$</td><td>N</td><td></td><td>$\mathbf{f}_{\mathrm{k}}=\mu_{\mathrm{k}}\mathbf{N}$</td></tr></tbody></table></body></html></div>
...
$$T,\quad(\mathrm{ii})\quad T-\frac{m v^{2}}{l},\quad(\mathrm{iii})\quad T+\frac{m v^{2}}{l},\quad(\mathrm{iv})\quad0$$
