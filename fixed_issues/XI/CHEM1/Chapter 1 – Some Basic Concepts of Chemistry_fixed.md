...
In numbers written in scientific notation,all digits are significant e.g.,$4.01\times10^{2}$ has three significant figures, and $8.256\times10^{-3}$ has four significant figures.
...
$\begin{array}{r l}&{\mathrm{M o l e c u l a r~m a s s~o f~g l u c o s e~(C_6H_{12}O_6)~}}\\ &{=6~(12.011~\mathrm{u})+12~(1.008~\mathrm{u})+}\\ &{=(72.066~\mathrm{u})+(12.096~\mathrm{u})+}\\ &{=~180.162~\mathrm{u}.}\end{array}$
...
\begin{aligned}&\overline{\hspace{1cm}}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad}&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad&\text{}\quad}&\text{}\quad\quad&\text{}\quad&\text{}\quad\quad&\text{}\quad&\text{}\quad\quad&\text{}\quad\quad&\text{}\quad}\quad&\text{}\quad\quad&\text{}\quad\quad&\text{}\quad\quad&\text{}\quad\quad&\text{}\quad\quad&\text{}\quad\quad\quad&\text{}\quad\quad&\text{}\quad\quad\quad&\quad\text{}\quad\quad&\quad\quad}&\text{}\quad\quad&\quad\quad\text{}\quad\quad&\quad\quad&\text{}\quad\quad\quad&\quad\quad&\text{}\quad\quad\quad&\quad\quad\quad&\text{}\quad\quad&\quad\quad\quad&\text{}\quad\quad\quad&\quad\quad\quad&\quad\quad\quad{\quad\quad\quad}&\quad\quad&\text\quad\quad&\quad\quad\quad{\quad\quad\quad}&\quad\quad&\quad\quad\quad&\text\quad\quad\quad&\quad\quad{\quad\quad\quad\quad}&\quad\quad&\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad&\quad&\quad\quad\quad\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad\quad\quad&\quad&\quad\quad\quad\quad\quad\quad\quad\quad\quad&\quad\quad&\quad&\quad\quad\quad\quad\quad\quad\quad&\quad\quad\quad\quad&\quad\quad\quad\quad\quad&\quad\quad\quad&\quad\quad\quad\quad\quad\quad 
...
The coefficients 2 for $ O_{2}$ and $\underline{{\mathrm{H}}}_{2}\mathrm{O}$ are called stoichiometric coefficients. Similarly the coefficient for $\mathrm{C H}_{4}$ and $\mathrm{CO}_{2}$ is one in each case. They represent the number of molecules (and moles as well) taking part in the reaction or formed in the reaction.
...
One molecule of $\mathrm{C H}_{4}(\mathrm{g})$ reacts with 2 molecules of $\mathrm{O}_{2}(\mathrm{g})$ to give one molecule of $\mathrm{C O}_{2}(\mathrm{g})$ Iand 2 molecules of $\mathrm{H_{2}O(g)}$

22. 7 L of $\mathrm{CH_{4}(g)}$ reacts with 45.4 L of $\mathrm{O}_{2}$ (g) to give 22.7 L of $\mathrm{C O}_{2}$ (g) and 45.4 L of

$\mathrm{H_{2}O(g)}$

16 g of $\mathrm{C H}_{4}$ (g) reacts with $2\times32$ gof $ O_{2}$ (g) to give $44~\mathrm{g}$ of $\mathrm{C O}_{2}$ (g) and $2\times18\mathrm{~g~}$ of
...
{\frac{\mathrm{M a s s}}{\mathrm{V o l u m e}}}=\mathrm{D e n s i t y}
...
Step 4 Balance the number $o f O$ atoms: There are 10 oxygen atoms on the right side $(3\times2=6)$ in $\mathrm{C O}_{2}$ and $4\times1=4$ in water). Therefore,five $\mathrm{O}_{2}$ molecules are needed to supply the required 10$\mathrm{C O}_{2}$ and $4\times1=4$ in water). Therefore, five $\mathrm{O}_{2}$ molecules are needed to supply the required 10 oxygen atoms.
...
According to the chemical equation,$\mathrm{CH_{4}(g)+2O_{2}(g)\rightarrow CO_{2}(g)+2H_{2}O}$ (g)$44\mathrm{g}\mathrm{C O_{_2}}$ (g) is obtained from 16g CH₄ (g).[∴1 mol $\mathrm{C O}_{2}(\mathrm{g})$ is obtained from l mol of $\mathrm{C H}_{4}(\mathrm{g})$
...
Hence, 0.5 mol $\mathrm{CO_{2}(g)}$ would be obtained from 0.5 mol $\mathrm{\bar{C H}}_{4}$ (g) or 0.5 mol of $\mathrm{C H}_{4}$ (g) would be required to produce $22\mathrm{~g~}\:\widetilde{\mathrm{C O}}_{2}$ $\mathrm{CO_{2}(g)}$

### Problem 1.5

50. 0 kg of $\mathrm{N}_{2}$ (g) and 10.0 kg of $\mathrm{H}_{2}$ (g)are mixed to produce $\mathrm{N H}_{3}$ (g). Calculate the amount of $\mathrm{N H}_{3}$ (g) formed. Identify the limiting reagent in the production of $\mathrm{N H}_{3}$ in this situation.
...
But we have only $4.96\times10^{3}$ mol $\mathrm{H}_{2}.$ Hence, dihydrogen is the limiting reagent in this case. So,$\mathrm{N H}_{_3}(\mathrm{g})$ would be formed only from that amount of available dihydrogen i.e.,$4.96\times10^{3}$ mol Since 3 mol $\mathrm{H}_{2}(\mathrm{g})$ gives 2 mol $\mathrm{N H}_{_3}(\mathrm{g})$
...
$3.30\times10^{3}$ mol $\mathrm{N H}_{3}$ is obtained.
...
$^{36}\mathrm{A r}$ $^{38}\mathrm{A r}$ cope 35.96755 g mol-1$37.96272~\mathrm{g~m o l^{-1}}$ nass 0.337%0.063%nc ,$^{40}\mathrm{Ar}$ 39. 9624 g mol-199.600%
...
1. 35Calcium carbonate reacts with aqueous HCl to give $\mathrm{C a C l}_{2}$ and $\mathrm{C O}_{2}$ according to the reaction,$\mathrm{CaCO_{3}(s)+2HCl(aq)\rightarrow CaCl_{2}(aq)+CO_{2}(g)+H_{2}O(l)}$
