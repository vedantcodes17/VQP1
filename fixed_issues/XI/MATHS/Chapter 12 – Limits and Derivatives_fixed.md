...
We say $\operatorname*{l i m}_{x\to a^{-}}f(x)$ is the expected value of f at $x=a$ given the values off near x to the left of a.This value is called the left hand limit off at a.

We say $\operatorname*{l i m}_{x\to a^{+}}f(x)$ is the expected value off at $x=a$ given the values of f near x to the right of a.This value is called the right hand limit of $f(x)$ at a.

If the right and left hand limits coincide, we call that common value as the limit $f(x)at x=a$ and denote it by $\operatorname*{l i m}_{x\to a}f(x)$
...
Hence,it is likely that the lefthand limit $\mathrm{of}f(x)$ and the right hand limit $\mathrm{o f}f(x)$ are both equal to 15. Thus,
...
As usual we make a table ofx near 0 withf(x). Observe that for negative values of we need to evaluate $x-2\mathrm{a n d}$ for positive values, we need to evaluate $x\pm2$
...
As usual we tabulate the values of f(x) for x near 1. From the values $\mathrm{o f}f(x)$ for less than 1,it seemsthatthe function should take value a $x=1$ ., i.e.,
...
12. 3.2Limitsof polynomialsandrationalfunctions A function $f$ is said to be a polynomial function of degree n $f(x)=a_{0}+a_{1}x+a_{2}x^{2}+\cdots+a_{n}x^{n}$ ,where $a_{i}s$ are real numbers such that $a_{_n}\ne0$ for some natural number n.
...
Theorem 4 (Sandwich Theorem) Let f,$f(x)\leq g(x)\leq h(x)$ for all x in the common domain of definition.For some real number a, if $\lim_{x\to a}f(x)=l=\lim_{x\to a^{-}}h(x)$ ,then lim $x→a$$

g(x)=1$ This is illustrated in Fig 12.9.
...
Area of $\Delta\mathrm{OAC}<\mathrm{Area}$ of sector $\mathrm{OAC}<\mathrm{Area}$ of $\Delta\operatorname{O A B}$
...
$ 8(cid:2)$\lim_{x\to3}\frac{x^4-81}{2x^2-5x-3}$ 9.$\lim_{x\to0}\frac{ax+b}{cx+1}$
...
What is $\operatorname*{l i m}_{x\to a_{1}}f(x)?$ For some $a\neq a_{1},\;a_{2},\;...,\;a_{n},$ ,compute $\lim_{x\to a}f(x)$

30. If $f(x)=\begin{cases}|x|+1,&x<0\\0,&x=0\\|x|-1,&x>0\end{cases}$

For what value (s) of a does ${\operatorname*{l i m}_{x\to a}}f(x){\mathrm{~e x i s t s?}}$

31. If the function $f(x)$ satisfies satisfies lim x→$$

\frac{f(x)-2}{x^2-1}=\pi$ $f(x)$
...
Theorem $\mathrm{Let}f(x)=a_n x^n+a_{n-1}x^{n-1}+\ldots+a_1x+a_0$ be a polynomial function, where $a_{_i}s$ are all real numbers and $a_{n}^{'}\ne0$ . Then, the derivative function is given by
...
Slished \left\{\begin{aligned}\frac{df(x)}{dx}=&\frac{d}{dx}(\sin x\sin x)\\ =&(\sin x)^{\prime}\sin x+\sin x(\sin x)^{\prime}\\ =&(\cos x)\sin x+\sin x(\cos x)\\ =&2\sin x\cos x-\sin2x\cdot\\ =&\frac{d}{dx}(\sin x\sin x)^{\prime}\sin x\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}}\cdot\frac{dx}{dx}\cdot\frac{d}{dx}\cdot\frac{dx}{dx}\cdot\frac{d}{dx}\cdot\frac{dx}{dx}}\cdot\frac{dx}{dx}\cdot\frac{dx}{dx}\cdot\frac{dx}{dx}\frac{dx}}\cdot\frac{dx}{dx}\frac{dx}{dx}\cdot\frac{dx}{dx}\frac{dx}}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}
