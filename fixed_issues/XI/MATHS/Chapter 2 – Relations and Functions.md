...
$$\mathrm{Now}(\mathrm{A}\times\mathrm{B})=\{(1,3),(1,4),(2,3),(2,4),(3,3),(3,4)\}\mathrm{and}_{\bar{C}}(\mathrm{A}\times\bar{\mathrm{C}})=\{(1,4),(1,5),(1,6),(2,4),(2,5),(2,6),(3,4),(3,5),(3,6)\}$$
...
$$f(x)=\left\{\begin{aligned}&1,if x>0\\ &0,if x=0\\ &-1,if x<0\end{aligned}\right.}f(x)=|x|$$
...
$$y=1f(x)=\frac{\left|x\right|}{x},x\in\mathbf{0}and\mathbf{0}for x=0$$
...
$$f(-4)=1-(-3)=4,\quad f(-2)=1-(-2)=3f(-1)=1-(-1)=2;\mathrm{e}^{-1}$$
