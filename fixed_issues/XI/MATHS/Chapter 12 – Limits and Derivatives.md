...
$$t_{2}-2\frac{Distance traveled in t_2seconds-19.6}{t_2-2}$$
...
$$\begin{aligned}\lim_{x\to1}x^2&=1,\quad\lim_{x\to1}x=1and\quad\lim_{x\to1}x+1=2\\lim_{x\to1}x^2&+\lim_{x\to1}x=1+1=2=\lim_{x\to1}\left[x^2+x\right].\end{aligned}y=f(x)$$
...
$$\lim_{x\to a}f(x)=\frac{\lim\limits_{x\to a}g(x)}{\lim\limits_{x\to a}h(x)}=\frac{\lim\limits_{x\to a}(x-a)^k g_1(x)}{\lim\limits_{x\to a}(x-a)^l h_1(x)}\frac{\lim\limits_{x\to a}(x-a)^{(k-l)}g_1(x)}{\lim\limits_{x\to a}h_1(x)}=\frac{0.g_1(a)}{h_1(a)}=0$$
...
$$\lim_{x\to-1}\left[1+x+x^2+\ldots+x^{10}\right]=1+(-1)^2+(-1)^{2}+\ldots+(-1)^{10} NCATT Aish e \lim_{x\to-1}\left[1+x+x^2+\ldots+x^{10}\right]=1+(-1)^2+(-1)^{2}+\ldots+(-1)^{10}1-1+1\ldots+1=1$$
...
$$\lim_{x\to1}\frac{x^{15}-1}{x^{10}-1}=\lim_{x\to1}\left[\frac{x^{15}-1}{x-1}\div\frac{x^{10}-1}{x-1}\right] uolished \lim_{x\to1}\left[\frac{x^{15}-1}{x-1}\right]\div\lim_{x\to1}\left[\frac{x^{10}-1}{x-1}\right] uolished $$
...
$$\mathrm{Put}y=1+x\quad\mathrm{so}\quad\mathrm{that}y\rightarrow1\quad\mathrm{as}x\rightarrow0.\lim_{x\to0}\frac{\sqrt{1+x}-1}{x}=\lim_{y\to1}\frac{\sqrt{y}-1}{y-1}=\lim_{y\to1}\frac{y^{\frac{1}{2}}-1^{\frac{1}{2}}}{y-1}=\lim_{x\to1}\frac{1}{2}=\lim_{y\to1}\frac{1}{2}$$
...
$$\lim_{x\to0}\frac{1-\cos x}{x}=\lim_{x\to0}\frac{2\sin^2\left(\frac{x}{2}\right)}{x}=\lim_{x\to0}\frac{\sin\left(\frac{x}{2}\right)}{\frac{x}{2}}\cdot\sin\left(\frac{x}{2}\right)\lim_{x\to0}\frac{\sin\left(\frac{x}{2}\right)}{\frac{x}{2}}\cdot\lim_{x\to0}\sin\left(\frac{x}{2}\right)=1.0=0$$
...
$$2.\lim_{x\to0}\left[\frac{\sin4x}{4x}\right]\div\left[\frac{\sin2x}{2x}\right]2.\lim_{4x\to0}\left[\frac{\sin4x}{4x}\right]\div\lim_{2x\to0}\left[\frac{\sin2x}{2x}\right]2.1.1=2\left(\mathrm{as}\;x\rightarrow0,\;4x\rightarrow0\;\mathrm{and}\;2x\rightarrow0\right)\lim_{x\to0}\frac{\tan x}{x}=\lim_{x\to0}\frac{\sin x}{x\cos x}=\lim_{x\to0}\frac{\sin x}{x}\cdot\lim_{x\to0}\frac{1}{\cos x}=1.1=1$$
...
$$\begin{aligned}f^{\prime}(-1)&=\lim_{h\to0}\frac{f(-1+h)-f(-1)}{h}\\&=\lim_{h\to0}\frac{\left[2(-1+h)^2+3(-1+h)-5\right]-\left[2(-1)^2+3(-1)-5\right]}{h}\\&=\lim_{h\to0}\frac{2h^2-h}{h}=\lim_{h\to0}(2h-1)=2(0)-1=-1\\f^{\prime}(0)&=\lim_{h\to0}\frac{f(0+h)-f(0)}{h}\\&=\lim_{h\to0}\frac{\left[2(0+h)^2+3(0+h)-5\right]-\left[2(0)^2+3(0)-5\right]}{h}\end{aligned}\lim_{h\to0}\frac{2h^2+3h}{h}=\lim_{h\to0}(2h+3)=2(0)+3=3$$
...
$$\frac{df(x)}{dx}=\lim_{h\to0}\frac{f(x+h)-f(x)}{h}=\lim_{h\to0}\frac{\tan(x+h)-\tan(x)}{h}=\lim_{h\to0}\frac{1}{h}\left[\frac{\sin(x+h)}{\cos(x+h)}-\frac{\sin x}{\cos x}\right]\begin{aligned}&\lim_{h\to0}\left[\frac{\sin(x+h)\cos x-\cos(x+h)\sin x}{h\cos(x+h)\cos x}\right]\\ &=\lim_{h\to0}\frac{\sin(x+h-x)}{h\cos(x+h)\cos x}\quad(using formula for\sin(A+B))\\ &=\lim_{h\to0}\frac{\sin h}{h}\cdot\lim_{h\to0}\frac{1}{\cos(x+h)\cos x}\\ &=1.\frac{1}{\cos^2x}=\sec^2x.\\ \end{aligned}Slished $$

Example 18 Compute the derivative of $f(x)=\sin^2x$ 

Solution We use the Leibnitz product rule to evaluate this.Slished 

$$Slished \left\{\begin{aligned}\frac{df(x)}{dx}=&\frac{d}{dx}(\sin x\sin x)\\ =&(\sin x)^{\prime}\sin x+\sin x(\sin x)^{\prime}\\ =&(\cos x)\sin x+\sin x(\cos x)\\ =&2\sin x\cos x-\sin2x\cdot\\ =&\frac{d}{dx}(\sin x\sin x)^{\prime}\sin x\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{d}{dx}\cdot\frac{dx}{dx}\cdot\frac{d}{dx}\cdot\frac{dx}{dx}\cdot\frac{d}{dx}\cdot\frac{dx}{dx}\cdot\frac{dx}{dx}\cdot\frac{dx}{dx}\cdot\frac{dx}{dx}\frac{dx}\cdot\frac{dx}{dx}\frac{dx}{dx}\cdot\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\frac{dx}\end{aligned}$$
...
$$f^{\prime}(x)=\lim_{h\to0}\frac{f(x+h)-f(x)}{h}=\lim_{h\to0}\frac{\frac{2(x+h)+3}{x+h-2}-\frac{2x+3}{x-2}}{h}\begin{aligned}&=\lim_{h\to0}\frac{(2x+2h+3)(x-2)-(2x+3)(x+h-2)}{h(x-2)(x+h-2)}\\&=\lim_{h\to0}\frac{(2x+3)(x-2)+2h(x-2)-(2x+3)(x-2)-h(2x+3)}{h(x-2)(x+h-2)}\\&=\lim_{h\to0}\frac{-7}{(x-2)(x+h-2)}=-\frac{7}{(x-2)^2}\end{aligned}hed $$
...
$$\begin{aligned}(i)\sin x+\cos x\quad&(ii)x\sin x\\ (iii)(i)\mathrm{we have}\quad&f(x)=\frac{f(x+h)-f(x)}{h}\\ &=\lim_{h\to0}\frac{\sin(x+h)+\cos(x+h)-\sin x-\cos x}{h}\\ &=\lim_{h\to0}\frac{\sin x\cos h+\cos x\sin h+\cos x\cos h-\sin x\sin h-\sin x-\cos x}{h}\end{aligned}\begin{aligned}=\lim_{h\rightarrow0}\frac{\sin h(\cos x-\sin x)+\sin x(\cos h-1)+\cos x(\cos h-1)}{h}\\=\lim_{h\rightarrow0}\frac{\sin h}{h}(\cos x-\sin x)+\lim_{h\rightarrow0}\sin x\frac{(\cos h-1)}{h}+\lim_{h\rightarrow0}\cos x\frac{(\cos h-1)}{h}\\=\cos x-\sin x\end{aligned}$$
...
$$h^{\prime}(x)=\frac{(x^{5}-\cos x)^{\prime}\sin x-(x^{5}-\cos x)(\sin x)^{\prime}}{(\sin x)^{2}}\begin{aligned}&\frac{(5x^{4}+\sin x)\sin x-(x^{5}-\cos x)\cos x}{\sin^{2}x}\\ &=\frac{-x^{5}\cos x+5x^{4}\sin x+1}{(\sin x)^{2}}\\ \end{aligned}$$
...
$$\lim_{x\to a}\frac{x^n-a^n}{x-a}=na^{n-1}\lim_{x\to0}\frac{\sin x}{x}=1\lim_{x\to0}\frac{1-\cos x}{x}=0$$
...
$$\frac{d}{dx}(x^n)=nx^{n-1} Lobe \frac{d}{dx}(\sin x)=\cos x Lobe \frac{d}{dx}(\cos x)=-\sin x Lobe $$
