...
Now,$f^{\prime}(x)>0for all x\in\left[0,\frac{\pi}{6}\right)as0\leq x<\frac{\pi}{6}\Rightarrow0\leq3x<\frac{\pi}{2}$ and $f^{\prime}(x)<0$ for all $x\in\left(\frac{\pi}{6},\frac{\pi}{2}\right)\quad as\quad\frac{\pi}{6}<x<\frac{\pi}{2}\Rightarrow\frac{\pi}{2}<3x<\frac{3\pi}{2}$ 
...
$$(i)$f(x)=e^{x}\quad(\mathrm{i i})\quad g(x)=\log x$$\begin{array}{r}{\mathrm{(i i i)}\quad h\left(x\right)=x^{3}+x^{2}+x+1}\end{array}$ $$
