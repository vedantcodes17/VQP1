...
$$\begin{aligned}&17\_e^{x}\left(\sin x+\cos x\right)\quad17\_\frac{x\ e^{x}}{\left(1+x\right)^{2}}\quad18\_\ e^{x}\left(\frac{1+\sin x}{1+\cos x}\right)\\ &21\_e^{x}\left(\frac{1}{x}-\frac{1}{x^{2}}\right)\quad20\_\frac{\left(x-3\right)e^{x}}{\left(x-1\right)^{3}}\quad21\_e^{2x}\sin x\\ &32\_\sin^{-1}\left(\frac{2x}{1+x^{2}}\right)\\ \end{aligned}$$
