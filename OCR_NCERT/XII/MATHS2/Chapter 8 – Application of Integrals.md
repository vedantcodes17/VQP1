...
$${\begin{array}{r l r}&{}&{y=~x}\\ &{{\mathrm{a n d}}\qquad x^{2}+y^{2}=~32.}\end{array}}$$
...
Example 5 Find the area bounded by the ellipse $\frac{x^{2}}{a^{2}}+\frac{y^{2}}{b^{2}}=1$ and the ordinates $x=0$ and $x=a e,\mathrm{w h e r e},b^{2}=a^{2}(1-e^{2})\mathrm{a n d}e<1$ 



Solution The required area (Fig 8.12) of the region BOB'RFSB is enclosed by the 

ellipse and the lines $x=0\;{\mathrm{a n d}}\;x=a e$ 
...
$$3\int_{0}^{2}\sqrt{4-x^{2}}dx-\int_{0}^{2}(6-3x)dx\quad(\mathrm{Why}?)$$

$$3\left[\frac{x}{2}\sqrt{4-x^{2}}+\frac{4}{2}\sin^{-1}\frac{x}{2}\right]^{2}-\left[6x-\frac{3x^{2}}{2}\right]^{2}_{0}$$
...
$$\begin{array}{r}{=\mathrm{A r e a~o f~}\Delta\mathrm{A B D~}+\mathrm{A r e a~o f~t r a p e z i u m}}\\ {\mathrm{B D E C}-\mathrm{A r e a~o f~}\Delta\mathrm{A E C}}\end{array}$$
...
$$\begin{aligned}(x-2)^{2}+y^{2}&=x^{2}+y^{2}\\x^{2}-4x+4+y^{2}&=x^{2}+y^{2}\\x=1which gives y&=\pm\sqrt[\cdot]{3}\end{aligned}$$
...
$$\left|\left[\frac{3x^{2}}{2}+2x\right]^{\frac{-2}{3}}\right|+\left[\frac{3x^{2}}{2}+2x\right]^{1}_{\frac{-2}{3}}=\frac{1}{6}+\frac{25}{6}=\frac{13}{3}$$
...
Solution From the Fig 8.22, the required $\mathtt{a r e a}=\mathtt{a r e a}$ of the region $\mathrm{OABO}+$ area of the region $\mathrm{B C D B}+\mathrm{a r e a}$ of the region DEFD.
...
$$\begin{aligned}&x=\left[\left(\frac{x^3}{3}+x\right)\right]_1^1+\left[\left(\frac{x^2}{2}+x\right)\right]_1^2\\ &=\left[\left(\frac{1}{3}+1\right)-0\right]+\left[(2+2)-\left(\frac{1}{2}+1\right)\right]=\frac{23}{6}\\ \end{aligned}$$
